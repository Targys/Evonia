	...
	render() {
		return (
				<div className="text contact">
					...
					<div>-soit vous contactez directement un des modérateurs, sur discord: Haru#7251, Unlike_TheFana#8082, Moxtor#9314, Targys#9643, OlopezO#9170, Papythorinque#6726, CokBot#6430, Cassis86#7323</div>
